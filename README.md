...
1. [Feature: OpenStudioLandscapes-LikeC4](#feature-openstudiolandscapes-likec4)
   1. [Brief](#brief)
...
# Feature: OpenStudioLandscapes-LikeC4
...
```shell
# cd .features
git clone https://github.com/michimussato/OpenStudioLandscapes-LikeC4.git
```
...
SBOMs for the different Python interpreters defined in [`.noxfile.VERSIONS`](https://github.com/michimussato/OpenStudioLandscapes-LikeC4/tree/main/noxfile.py) will be created in the [`.sbom`](https://github.com/michimussato/OpenStudioLandscapes-LikeC4/tree/main/.sbom) directory of this repository.
...
The following variables are being declared in `OpenStudioLandscapes.LikeC4.constants` and are accessible throughout the [`OpenStudioLandscapes-LikeC4`](https://github.com/michimussato/OpenStudioLandscapes-LikeC4/tree/main/src/OpenStudioLandscapes/LikeC4/constants.py) package.
