...
# cd OpenStudioLandscapes
source .venv/bin/activate
openstudiolandscapes clone-feature --repo=https://github.com/michimussato/OpenStudioLandscapes-LikeC4.git --install
deactivate
```
...
# cd OpenStudioLandscapes
source .venv/bin/activate
pip uninstall OpenStudioLandscapes-LikeC4
deactivate
```
...
Last changed: **2026-07-09 12:13:42 UTC**