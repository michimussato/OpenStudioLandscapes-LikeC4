<!-- TOC -->
* [OpenStudioLandscapes-LikeC4](#openstudiolandscapes-likec4)
<!-- TOC -->
...
Instead of the [`definitions.py`](src/OpenStudioLandscapes/LikeC4/definitions.py), 
the accompanying [`workspace.yaml`](workspace.yaml) loads 
the [`_definitions_with_upstream_specs.py`](src/OpenStudioLandscapes/LikeC4/_definitions_with_upstream_specs.py) 
which also contains 
