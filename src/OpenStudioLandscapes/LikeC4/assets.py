    ...
    **constants.ASSET_HEADER,
    ins={
        ...
        "download_sources": AssetIn(
            AssetKey([*constants.ASSET_HEADER["key_prefix"], "download_sources"]),
        ),
    },
)
def extract_sources(
    ...
    **constants.ASSET_HEADER,
    ins={
        ...
        "extract_sources": AssetIn(
            AssetKey([*constants.ASSET_HEADER["key_prefix"], "extract_sources"]),
        ),
    },
)
def compose_likec4(
    ...
    **constants.ASSET_HEADER,
    ins={
        "compose_likec4": AssetIn(
            AssetKey([*constants.ASSET_HEADER["key_prefix"], "compose_likec4"]),
        ),
    },
)
def compose_maps(
